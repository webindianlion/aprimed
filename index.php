...
<div class="page-wrapper">
				...
				<div class="auto-container">
					...
					<div class="content-column">
						<div class="inner-column">
							...
							<h1>Quality & Accessible Medicines for all</h1>
							<div class="text">We provide innovative & quality products to patients across Africa</div>
							<div class="btns-box">
								<a href="aboutus.html" class="theme-btn btn-style-one"><span class="txt">Read More</span></a>
							</div>
						</div>
					</div>
			...
			<div class="slide" style="background-image: url(images/main-slider/image-2.jpg)">
				...
				<div class="auto-container">
					...
					<div class="content-column">
						<div class="inner-column">
							<div class="patern-layer-three" style="background-image: url(images/main-slider/pattern-3.png)"></div>
							<h1>Value through Innovation</h1>
							<div class="text">WHERE INNOVATION SHAPES HEALTHCARE SOLUTIONS</div>
							<div class="btns-box">
								<a href="aboutus.html" class="theme-btn btn-style-one"><span class="txt">Read More</span></a>
							</div>
						</div>
	...
	<section class="about-section">
      ...
      Quality Management      </h6>
									<div class="feature-text">“We strive for Total customer satisfaction through continuous improvements in processes and systems, delivering consistent quality meeting International standards”</div>
								</div>
							</div>
						...
						<a href="#" class="lightbox-image theme-btn btn-style-one"><span class="txt"><i class="play-icon"><img src="images/icons/play-icon.png" alt="" /></i>&ensp; Read More</span></a>
		...
		<div class="auto-container">
			<div class="row clearfix">
				...
				<div class="button-column col-lg-4 col-md-12 col-sm-12">
					<div class="inner-column">
						<a href="contactus.html" class="theme-btn btn-style-two"><span class="txt">Contact Us</span></a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="auto-container">
			<div class="row clearfix">
				...
				<div class="feature-block-two col-lg-6 col-md-12 col-sm-12">
					<div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms" style="background-image: url(images/resource/feature-1.jpg)"><br><br>
						
						<div class="text">We make better health possible with more than 20 products in 70% of therapy areas at 1,000 pharmacies in selected markets of AAfrican population</div>
					</div>
				</div>
				...
				<div class="feature-block-two col-lg-6 col-md-12 col-sm-12">
					<div class="inner-box wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms" style="background-image: url(images/resource/feature-2.jpg)">
						...
						<h4>"In Africa, For Africa"</h4>
						<div class="text">Africa is an investment priority, we are proud of the work we do in Africa and we believe it makes a substantial positive impact to the health of Africans.</div>
					</div>
				</div>
